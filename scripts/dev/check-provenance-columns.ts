...
const ALLOWLIST: Record<string, string> = {
  ...
  "contact_phone.created_at": "RETIRE — Retire Contact Timestamps",
  "contact_postal.created_at": "RETIRE — Retire Contact Timestamps",
  "contact_postal.updated_at": "RETIRE — Retire Contact Timestamps",
