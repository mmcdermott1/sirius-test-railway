...
import { type AuthIdentityStorage, createAuthIdentityStorage } from "./auth-identities";
...
export interface IStorage {
  ...
  authIdentities: AuthIdentityStorage;
}
...
export class DatabaseStorage implements IStorage {
  ...
  constructor() {
    ...
    this.authIdentities = createAuthIdentityStorage();
  }
}
