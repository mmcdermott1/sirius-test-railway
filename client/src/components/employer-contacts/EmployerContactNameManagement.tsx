...
interface EmployerContactNameManagementProps {
...
export default function EmployerContactNameManagement({ 
  employerContactId,
  contactDisplayName,
  contactData
}: EmployerContactNameManagementProps) {
  ...
  const updateNameMutation = useMutation({
    mutationFn: async (components: NameComponents) => {
      return apiRequest("PATCH", `/api/employer-contacts/${employerContactId}`, { nameComponents: components });
    },
    onSuccess: () => {
